...
async function searchSra(term) {
  ...
  if (!es.ok) throw new Error("NCBI esearch 失敗（GitHub Pages 可能被 CORS 擋住，請用 10.0.1.118:8770）");
...
async function loadStatus() {
  ...
  if (!hit) {
    box.textContent =
      "目前是 GitHub Pages 靜態站，看不到 10.0.1.118 的下載行程（HTTPS 不能呼叫區網 HTTP）。\n" +
      "請在區網開啟 http://10.0.1.118:8770/ 看進度。\n" +
